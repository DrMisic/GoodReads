...
public class KnjigaAutorDto {
    ...
    public KnjigaAutorDto(String naslov, String naslovnaFotografija, double ISBN, int brojStrana, Date datumObjavljivanja, String opis, Long autorId, Long zanrId) {
        this.naslov = naslov;
    ...
    public KnjigaAutorDto(Knjiga knjiga) {
        ...
        this.naslovnaFotografija = knjiga.getNaslovna_fotografija();
        this.isbn = knjiga.getISBN();
        this.brojStrana = knjiga.getBroj_strana();
        this.datumObjavljivanja = knjiga.getDatum_objavljivanja();
